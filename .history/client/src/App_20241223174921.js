...
const App = () => {
    ...
    process.env.NODE_ENV === 'production'
        ? 'https://simple-web-service-d24c4ba0d0d9.herokuapp.com'
        : 'http://localhost:5000';
    ...
    return (
        <Container maxWidth="sm" sx={{ mt: 4 }}>
            ...
            >
                ...
                <ToggleButton value="completed">Завершены</ToggleButton>
                <ToggleButton value="incomplete">В процессе</ToggleButton>
            </ToggleButtonGroup>
